...
!*****************************************************************
    integer:: estimate
        double precision, dimension(:,:),allocatable,save::Kmat1,Kmat2
    integer, save:: corrRE
    ...
    double precision,dimension(:,:),allocatable:: nodes,weights
      ...
      integer,save::npp,ni_cur, which_random
        double precision,save::vals,agemin,sig_fixed
        integer ,save:: all, nnodes_all
        double precision,dimension(:),allocatable,save ::range,currentage
        integer,dimension(:),allocatable,save::RE_which
        !double precision,parameter::pi = 3.141592653589793238462643d0
        double precision,dimension(:),allocatable,save:: vi
        integer,dimension(:),allocatable,save:: nmesrec,nmesy,nmesrec1,proband
        integer,save :: maxmesy, maxmesrec
        integer,dimension(:),allocatable,save:: groupee,groupeey,cpt2
!*****dace1
...
!*****dace2
    ...
    integer,dimension(:),allocatable,save:: nt0,nt1,nt2,ntU
...
!***** random effects
        ...
        integer,save :: linkidyr,linkidyd,link
         double precision,dimension(:,:),allocatable,save::Ut,Ut_det,Utt,Ut22,Utt2,varcov_marg,sum_mat
        double precision,dimension(:),allocatable,save::Ut_table
        !****** censure à gauche
...
!*****groupe
    ...
    integer,dimension(:),allocatable,save::nig,nmemb!(ngmax)  ! nb d events recurrents par sujet
!*****mem1
...
!******  aux1 aux2
    double precision,dimension(:),allocatable,save::res1,res3,res4,res5,res6,res2_ind,res3_ind
    !double precision,dimension(:),allocatable,save::res1dc,res2dc,res3dc,res4dc,res5dc
    double precision,dimension(:),allocatable,save::aux1,aux2,sig_prob,sig_prob2
...
! distribution des frailty par une log-normale
    ...
    double precision,save::sig2,sig22, det
...
!*****invD
    ...
    module residusM
        double precision,dimension(:),allocatable,save::Residus, &
            varResidus,cumulhaz,cumulhaz_corr,vecuiRes,post_esp,post_SD,som_Xbeta
        double precision,dimension(:),allocatable,save::ResidusRec,&
            Residusdc,Rrec,Nrec,Rdc,Ndc,vecviRes,RisqCumul,ResidusLongi,&
            Rdc_res ,Nrec_fam,Ndc_fam,Nrec_ind!,cumhaz_obs
        ...
        double precision,save::detSigma
           integer,save :: nig_mc,np_mc,ind_cur
