...
! ============================================== prediction Joint
    ...
    !=========================
        ...
        if(link.eq.2) then
            frailvec(1) = frail
            call integrationdc(survdcCM_pred,0.d0,predtime_cm(1),resultdc,abserr,resabs,resasc,1,b1,npp,frailvec)
            survDC(1) = resultdc    
            call integrationdc(survdcCM_pred,0.d0,predtime_cm(2),resultdc,abserr,resabs,resasc,1,b1,npp,frailvec)
            survDC(2) = resultdc    
        end if  
