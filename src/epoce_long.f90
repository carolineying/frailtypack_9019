    ...
    double precision :: yscalar
        ...
        double precision,dimension(1)::frailvec
                ...
                sudc = dexp(-(T/etaD)**betaD)
                    ...
                    vraisind = vraisind*sudc**(vet2&
                            *dexp(etaydc(1)*frail))
                            ...
                            nzdc = nz2
                frailvec(1) = frail
                call integrationdc(survdcCM,t0dc(i),T,sudc,abserr,resabs,resasc,i,b1,npp,frailvec)
        ...
        do j=1,2
            ...
            if ((g(k).eq.i).and.(t1(k).le.vals)) then
                    ...
                    case(2)
                                            ...
                                            resultR = 0.d0
                                            call integrationdc(survRCM,t0(k),t1(k),resultR,abserr,resabs,resasc,k,b1,npp,xea22(1:1))
    ...
    vraisind = vraisind*sudc**(vet2&
            ...
            nzdc = nz2
                        call integrationdc(survdcCM,t0dc(i),T,sudc,abserr,resabs,resasc,i,b1,npp,Xea22(1:1))
