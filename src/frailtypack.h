...
void
F77_SUB(adaptive_gk_test)(int *ndim, int *testcase, int *method,
                        int *minpts, int *maxpts, double *epsabs,
                        double *epsrel, double *shift, double *ridge,
                        double *result, double *abserr, int *neval,
                        int *ifail, double *analytic, int *status);

void
F77_SUB(adaptive_gk_matrix_test)(int *ndim, int *testcase, int *method,
                                 int *minpts, int *maxpts, double *epsabs,
                                 double *epsrel, double *target_mean,
                                 double *target_precision_chol,
                                 double *proposal_mean,
                                 double *proposal_precision_chol,
                                 double *proposal_scale, double *constant,
                                 double *result, double *abserr, int *neval,
                                 int *ifail, int *status, double *logpositive,
                                 double *lognegative);

void
F77_SUB(adaptive_mode_test)(int *ndim, double *prior_chol, double *delta,
                            double *hazard, double *mode_tol, int *maxit,
                            double *hessian_eps, double *mode_z,
                            double *log_mode, double *gradient,
                            double *hessian, double *chol_h, int *status,
                            int *iterations, double *gradnorm, double *mineig,
                            double *minstab, double *condition,
                            int *regularized);

void
F77_SUB(adaptive_survival_test)(int *ndim, int *method, int *minpts,
                                int *maxpts, double *epsabs, double *epsrel,
                                double *prior_chol, double *delta,
                                double *hazard, double *proposal_scale,
                                double *proposal_shift, double *result,
                                double *abserr, int *neval, int *ifail,
                                int *status, double *laplace, double *mode_z,
                                double *gradient, double *hessian,
                                double *chol_h, int *iterations,
                                double *gradnorm, double *mineig,
                                double *minstab, double *condition,
                                int *regularized);

void
F77_SUB(ascertainment_gaussian_test)(double *cumulative_hazard,
                                     double *variance, double *result);

void
F77_SUB(correlated_weib_cleanup_test)(int *status);
...
F77_SUB(frailpenal)(int *nsujetAux, int *ngAux, int *icenAux, int *nstAux, int *effetAux,
                        ...
                        double *BetaTpsMat, double *EPS, double *Kmat10, double *Kmat20,
                        int *corrRE_proband0, double *currentage0, 
                        double *agemin_sig_fixed, double *Fisher0, double *IOut);
...
void 
F77_SUB(joint)(int *nsujet0, int *ngrp, int *nstRecAux, int *strAux, int *lignedc0, int *nz0, 
                        ...
                        double *vaxdc00, int *noVar,  int *maxit0, int *np, double *b, 
                        double *H_hessOut, double *HIHOut, double *resOut, double *LCV, double *x1Out, 
                        double *lamOut, double *xSu1, double *suOut, double *x2Out, 
                        double *lam2Out, double *xSu2, double *su2Out, int *typeof0,
                        int *equidistant, int *nbinterv0, int *mtaille, int *counts, 
