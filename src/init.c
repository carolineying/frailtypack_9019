...
static const R_FortranMethodDef FortEntries[] = {
    {"adaptive_gk_test",     (DL_FUNC) &F77_SUB(adaptive_gk_test),     15},
    {"adaptive_gk_matrix_test", (DL_FUNC) &F77_SUB(adaptive_gk_matrix_test), 20},
    {"adaptive_mode_test",   (DL_FUNC) &F77_SUB(adaptive_mode_test),   19},
    {"adaptive_survival_test", (DL_FUNC) &F77_SUB(adaptive_survival_test), 27},
    {"ascertainment_gaussian_test", (DL_FUNC) &F77_SUB(ascertainment_gaussian_test), 3},
    {"correlated_weib_cleanup_test", (DL_FUNC) &F77_SUB(correlated_weib_cleanup_test), 1},
    ...
    {"frailpenal",           (DL_FUNC) &F77_SUB(frailpenal),           65},
